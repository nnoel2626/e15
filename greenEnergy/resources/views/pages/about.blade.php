...
<!-- section -->
<div class="section padding_layout_1" id="about">
  <div class="container">
    <div class="row">
      ...
      <div class="container"> --}}
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <img src="/images/it_service/about-mission.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              <div class="img">
                <img src="/images/it_service/about-plan.jpg" alt="" class="img-fluid">
                <div class="icon"><i class="ion-ios-list-outline"></i></div>
              </div>
              <h3 class="title"><a href="#">Our Plan</a></h3>
              <p>
                Green Energy Solutions strives to make renewable energy as a real alternative to what we have currently. GES has developed a reliable business network with local and international manufactures and solar energy system integrators in Haiti and has become a comprehensive and efficient reference for PV system equipment supply
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="/images/it_service/about-vision.jpg" alt="" class="img-fluid">
                <div class="icon"><i class="ion-ios-eye-outline"></i></div>
              </div>
              <h3 class="title"><a href="#">Our Vision</a></h3>
              <p>
                Green Energy Solutions is focusing on training and investing heavily on its work force to create a pool of professionals specializing in solar photovoltaic technology. GES's objective is to create solid partnerships and to train at least 100 employees specialized in solar installation to meet the demand in the coming years.
              </p>
            </div>
          </div>
